...
<body class="flex flex-col min-h-screen">
    ...
    <header
        class="fixed top-0 w-full px-10 py-5 flex justify-between items-center z-50 bg-[rgba(8,8,44,0.95)] shadow-xl border-b border-gray-700">
        <h2 class="text-white text-2xl font-bold tracking-wider uppercase">Ruta Larga</h2>
        <nav class="flex items-center gap-6">
            <a href="logout.php"
                class="bg-red-600 hover:bg-red-700 text-white px-5 py-2 rounded-lg text-xs font-bold uppercase tracking-widest transition-all hover:scale-105 active:scale-95 shadow-lg">
                Cerrar Sesión
            </a>
        </nav>
    </header>
    ...
    <main class="flex-grow pt-32 pb-20 px-6 max-w-7xl mx-auto w-full">
        ...
        <div class="text-center mb-16">
            ...
            <p class="text-gray-200 uppercase tracking-[0.2em] text-xs font-semibold drop-shadow-sm">Seleccione una
        ...
        <div class="flex flex-wrap justify-center gap-8">
            ...
            <a href="clientes.php"
                ...
                <p class="text-gray-600 text-sm leading-relaxed">Gestión de base de datos de clientes, contratos e
                    historiales.</p>
                <div
                    class="mt-6 text-blue-600 font-bold text-[10px] uppercase tracking-[0.2em] flex items-center gap-2">
                    Acceder Módulo <i class="ph ph-caret-double-right"></i>
                </div>
            </a>
            ...
            <a href="inventario.php"
                ...
                <p class="text-gray-600 text-sm leading-relaxed">Control de repuestos, stock de flota y auditoría de
                    recursos.</p>
                <div
                    class="mt-6 text-yellow-600 font-bold text-[10px] uppercase tracking-[0.2em] flex items-center gap-2">
                    Acceder Módulo <i class="ph ph-caret-double-right"></i>
                </div>
            </a>
    ...
    <footer
        class="bg-[rgb(8,8,44)] text-gray-400 py-10 text-center text-[10px] tracking-[0.3em] uppercase mt-auto border-t border-gray-800">
