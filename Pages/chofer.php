                ...
                <?php while ($fila = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td class="text-center">
                            <button class="btn btn-info btn-sm btnEditar" data-id="<?= $fila['ID_chofer'] ?>"
                ...
                <form method="POST">
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="modal-footer"><button type="submit" name="registrar"
                                class="btn btn-success btn-block">Guardar Chofer</button></div>
                </form>
            </div>
        </div>
    </div>
                ...
                <form method="POST">
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="modal-footer"><button type="submit" name="editar"
                                class="btn btn-info btn-block">Actualizar Chofer</button></div>
                </form>
            </div>
        </div>
    </div>
