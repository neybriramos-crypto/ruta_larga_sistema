...
<body>
            ...
            <div class="modal-content border-0">
                <form method="POST">
                    ...
                    <div class="modal-body p-4">
                        <div class="form-group"><label>Placa</label><input type="text" name="placa" class="form-control text-uppercase" required placeholder="ABC-123"></div>
            ...
            <div class="modal-content border-0">
                <form method="POST">
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="form-group">
                            <label>Modelo</label>
                            <select name="modelo" id="edit_modelo" class="form-control select-modelo" required>
                                </select>
                        </div>
                    </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            // Evento cambio de marca en Registro
            $('#reg_marca').on('change', function() {
                actualizarModelos('#reg_marca', '#reg_modelo');
            });

            // Evento cambio de marca en Edición
            $('#edit_marca').on('change', function() {
                actualizarModelos('#edit_marca', '#edit_modelo');
            });
            ...
            $('#tablaVehiculos').on('click', '.btnEditar', function () {
                ...
                // Cargar modelos de esa marca y pre-seleccionar el actual
                actualizarModelos('#edit_marca', '#edit_modelo', modelo);
